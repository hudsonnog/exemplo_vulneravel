                ...
                <ul>
                    <li><a href="#">A1- Injection</a>
                        <ul>
                            <li><a href="#">SQL Injection</a>
                                <ul>
                                    <li><a href="<%=path%>/vulnerability/forumposts.jsp?postid=1">Sql Injection 1</a>
                                    </li>
                            ...
                            <li><a href="#">XPath Injection</a>
                                <ul>
                                    <li><a href="<%=path%>/vulnerability/Injection/xpath_login.jsp">Login Bypass</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a href="#">XML Injection</a>
                                <ul>
                                    ...
                                    <li><a href="<%=path%>/vulnerability/Injection/xslt.jsp?style=1.xsl">XSLT
                                        Injection</a></li>
                    ...
                    <li><a href="#">A2- Broken Authentication & Session Management</a>
                        <ul>
                            ...
                            <li>
                                <a href="<%=path%>/vulnerability/baasm/URLRewriting.jsp;jsessionid=<%=session.getId()%>">Session
                                    ID in URL</a></li>
                            <li><a href="<%=path%>/vulnerability/baasm/SiteTitle.jsp">Improper Authentication: Privilege
                                Escalation</a></li>
                    ...
                    <li><a href="#">A3- XSS</a>
                        <ul>
                            ...
                            <li><a href="#">Flash Based</a>
                                <ul>
                                    <li><a href="<%=path%>/vulnerability/xss/flash/xss1.swf?vuln=<%=path%>">Challenge
                                        1</a></li>
                    ...
                    <li><a href="#">A4-Insecure Direct Object References</a>
                        <ul>
                            ...
                            <li><a href="<%=path%>/vulnerability/idor/change-email.jsp"
                                   title="Make sure you have logged in ">Modifying email ID</a>
                            </li>
                    ...
                    <li><a href="#">A5-Security Misconfiguration</a>
                        <ul>
                            ...
                            <li><a href="<%=path%>/vulnerability/securitymisconfig/pages.jsp?id=1">Error Handling</a>
                            </li>
                    ...
                    <li><a href="#">A6-Sensitive Data Exposure</a>
                        <ul>
                            <li><a href="<%=path%>/changeCardDetails.jsp">Cleartext Transmission of Sensitive
                                Information</a></li>
                            <li><a href="<%=path%>/ForgotPassword.jsp">Storing Login Credentials in Plain Text</a></li>
                            <li><a href="<%=path%>/login.jsp">Storing Login Credentials in Plain Text in a cookie</a>
                            </li>
                    ...
                    <li><a href="#">A7- Missing Function Level Access Control</a>
                        <ul>
                            <li><a href="<%=path%>/admin/" title="Hint: Forced Browsing">Challenge 1:Bypass Admin
                                Login</a></li>
                    ...
                    <li><a href="#">A8- CSRF</a>
                        <ul>
                            ...
                            <li><a href="<%=path%>/vulnerability/csrf/changepassword.jsp">CSRF 2(POST): Change
                                Password</a></li>
                        </ul>
                    </li>
                    <li><a href="#">A9- Using components with known vulnerabilities</a>
                        <ul>
                            <li><a href="/VulnerableSpring/error.htm?msg=error.c403">Web Application using Spring
                                Framework</a></li>
                        </ul>
                    </li>
